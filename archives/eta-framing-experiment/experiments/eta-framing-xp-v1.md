...
| Success (L1) | Conversion Rate (PDP → Order Placed) | \# of users placing order / \# of users landing on PDP | | |
...
- Handling for TG1:
  - On the Order Summary screen, customers should see the relative days format: "Arrives in X–Y days".
