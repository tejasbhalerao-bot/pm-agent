...
|---|---|---|---|---|---|---|
| SDD Expansion | Pincodes with high traffic, low conversion, customer receptivity to faster delivery, and weak competitive positioning are where SDD moves the needle most. | SDD-eligible pincodes;<br>SDD conversion rate | — | — | H1 → H2 | • Score pincodes on traffic × conversion gap × customer receptivity × competitive positioning<br>• Map SKU eligibility for SDD<br>• Assess dark store readiness per priority pincode |
